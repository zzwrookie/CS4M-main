...
DUAL_CHANNEL_NODE_SUPPORT_ENABLED="${DUAL_CHANNEL_NODE_SUPPORT_ENABLED:-false}"
DUAL_CHANNEL_NODE_SUPPORT_SCORE_FLOOR="${DUAL_CHANNEL_NODE_SUPPORT_SCORE_FLOOR:-0.0}"
DUAL_CHANNEL_NODE_SUPPORT_THRESHOLD="${DUAL_CHANNEL_NODE_SUPPORT_THRESHOLD:-2}"
...
pipeline_args=(
    ...
    --dual_channel_node_support_enabled "${DUAL_CHANNEL_NODE_SUPPORT_ENABLED}"
    --dual_channel_node_support_score_floor "${DUAL_CHANNEL_NODE_SUPPORT_SCORE_FLOOR}"
    --dual_channel_node_support_threshold "${DUAL_CHANNEL_NODE_SUPPORT_THRESHOLD}"
    --dual_channel_node_support_channel "${DUAL_CHANNEL_NODE_SUPPORT_CHANNEL}"
